...
export class DeepInfraTranslationAdapter implements ITranslationService {
  ...
  public async translateImage(
    ...
    return executeTranslation(model, image, targetLanguage, 'DEEPINFRA', this.userPreferences.includeDescription, this.structuredOutputExemptions, cancellationToken);
  }
}
