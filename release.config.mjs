  ...
  plugins: [
    ...
    [
      '@semantic-release/exec',
      {
        ...
        publishCmd:
          'npx chrome-webstore-upload-cli@3 upload --source chrome-v${nextRelease.version}.zip && npx chrome-webstore-upload-cli@3 publish && npx web-ext sign --source-dir dist/firefox --channel listed --api-key $AMO_JWT_ISSUER --api-secret $AMO_JWT_SECRET',
      },
    ],
