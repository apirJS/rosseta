...
export class AnthropicTranslationAdapter implements ITranslationService {
  ...
  public async translateImage(
    ...
    return executeTranslation(model, image, targetLanguage, 'ANTHROPIC', this.userPreferences.includeDescription, this.structuredOutputExemptions, cancellationToken);
  }
}
